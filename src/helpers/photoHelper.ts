...
export async function getImagesFromApi(name:string):Promise<string[]> {
    try {
...
export const getRendomPhoto =async (keyword:string)=>{
    const images =await getImagesFromApi(keyword)
